...
function dogovor_doc ($id){
    ...
    $section->addText('           '.$company.', яке є платником податку _______________________ за ___________ ставкою, що визначена п._________ Податкового кодексу України та є (ні є) платником ПДВ, далі за текстом – «ДОРУЧИТЕЛЬ», в особі ________________ , який діє на підставі Статуту, з однієї сторони, і фізична особа-підприємець Коржов Андрій Анатолійович, який є платником єдиного податку за ставкою 5% та ні є платником ПДВ, далі за текстом – «ПОВІРЕНИЙ» (номер запису в Єдиному державному реєстрі  2 480 017 0000 009334 від 23.08.2002 р., зареєстрований у реєстрі митних брокерів  від 19/06/2015р  АЕ №294128), з іньшої сторони, уклали Договор про наведене нижче:',
