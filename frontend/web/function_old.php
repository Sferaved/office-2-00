...
function dogovor_doc ($id){
    ...
    $section->addText('           '.$company.', яке є платником податку _______________________ за ___________ ставкою, що визначена п._________ Податкового кодексу України та є (ні є) платником ПДВ, далі за текстом – «ДОРУЧИТЕЛЬ», в особі ________________ , який діє на підставі Статуту, з однієї сторони, і фізична особа-підприємець Коржов Андрій Анатолійович, який є платником єдиного податку за ставкою 5% та ні є платником ПДВ, далі за текстом – «ПОВІРЕНИЙ» (номер запису в Єдиному державному реєстрі  2 480 017 0000 009334 від 23.08.2002 р., зареєстрований у реєстрі митних брокерів  від 19.11.2024 №MB/002110/01), з іньшої сторони, уклали Договор про наведене нижче:',
...
if ($aq_fl_id==3)
{
    ...
    $fontStyle = array('name' => 'Times New Roman', 'size'=>12);
    $section->addText(
        '       ТОВ  “Акваізол” (надалі “ДОРУЧИТЕЛЬ”) в особі директора Файнера Д.І., діючого на підставі Статуту, і ФО-П Коржов А.А. (надалі “ПОВІРЕНИЙ”), що діє на підставі запису в Єдиному державному реєстрі 2 480 017 0000 009334 від 23.08.2002 р. та зареєстрований у реєстрі митних брокерів від 19.11.2024 №MB/002110/01, уклали додаткову угоду про наведене нижче:',
        $fontStyle, 'Paragraph_2'
    );
