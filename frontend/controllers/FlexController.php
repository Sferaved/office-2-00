...
use frontend\models\FlexSearch;
use frontend\models\Declaration;
use common\models\Contragent;

/**
 * FlexController implements the CRUD actions for Flex model.
 */
class FlexController extends Controller
{
    ...
    /**
     * Lists all Flex models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new FlexSearch();
...
//Итоги по Досмотр	
    ...
    /**
     * Updates an existing Flex model.
    ...
    /**
     * Deletes an existing Flex model.
    ...
    /**
     * Finds the Flex model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Flex the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Flex::findOne($id)) !== null) {
            return $model;
        }
